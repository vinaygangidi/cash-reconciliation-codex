...
For setup and the live demo, see the repository [README](../README.md).

Historical documents describing superseded designs are retained in [archive/](archive/) for context only. They must not be used as implementation references.
